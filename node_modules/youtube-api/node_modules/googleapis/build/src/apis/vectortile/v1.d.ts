...
export declare namespace vectortile_v1 {
    ...
    export interface Schema$FeatureTile {
        ...
        /**
         * Resource name of the tile. The tile resource name is prefixed by its collection ID `tiles/` followed by the resource ID, which encodes the tile&#39;s global x and y coordinates and zoom level as `@&lt;x&gt;,&lt;y&gt;,&lt;zoom&gt;z`. For example, `tiles/@1,2,3z`.
         */
        name?: string | null;
        /**
    ...
    export interface Schema$TerrainTile {
        ...
        /**
         * Resource name of the tile. The tile resource name is prefixed by its collection ID `terrain/` followed by the resource ID, which encodes the tile&#39;s global x and y coordinates and zoom level as `@&lt;x&gt;,&lt;y&gt;,&lt;zoom&gt;z`. For example, `terrain/@1,2,3z`.
         */
        name?: string | null;
        /**
    ...
    export class Resource$Featuretiles {
         ...
         * @param {string=} params.clientInfo.userId A client-generated user ID. The ID should be generated and persisted during the first user session or whenever a pre-existing ID is not found. The exact format is up to the client. This must be non-empty in a GetFeatureTileRequest (whether via the header or GetFeatureTileRequest.client_info).
         ...
         * @param {string} params.name Required. Resource name of the tile. The tile resource name is prefixed by its collection ID `tiles/` followed by the resource ID, which encodes the tile's global x and y coordinates and zoom level as `@<x>,<y>,<zoom>z`. For example, `tiles/@1,2,3z`.
    ...
    export interface Params$Resource$Featuretiles$Get extends StandardParameters {
        ...
        /**
         * A client-generated user ID. The ID should be generated and persisted during the first user session or whenever a pre-existing ID is not found. The exact format is up to the client. This must be non-empty in a GetFeatureTileRequest (whether via the header or GetFeatureTileRequest.client_info).
         */
        ...
        languageCode?: string;
        /**
         * Required. Resource name of the tile. The tile resource name is prefixed by its collection ID `tiles/` followed by the resource ID, which encodes the tile's global x and y coordinates and zoom level as `@<x>,<y>,<zoom>z`. For example, `tiles/@1,2,3z`.
         */
        name?: string;
        /**
    ...
    export class Resource$Terraintiles {
         ...
         * @param {string} params.name Required. Resource name of the tile. The tile resource name is prefixed by its collection ID `terraintiles/` followed by the resource ID, which encodes the tile's global x and y coordinates and zoom level as `@<x>,<y>,<zoom>z`. For example, `terraintiles/@1,2,3z`.
    ...
    export interface Params$Resource$Terraintiles$Get extends StandardParameters {
        ...
        /**
         * Required. Resource name of the tile. The tile resource name is prefixed by its collection ID `terraintiles/` followed by the resource ID, which encodes the tile's global x and y coordinates and zoom level as `@<x>,<y>,<zoom>z`. For example, `terraintiles/@1,2,3z`.
         */
        name?: string;
        /**
         * Terrain formats that the client understands.
