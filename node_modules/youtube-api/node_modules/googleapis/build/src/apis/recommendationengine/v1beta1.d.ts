...
export declare namespace recommendationengine_v1beta1 {
    ...
    /**
     * Configures what level the catalog should be uploaded with regards to how users will be send events and how predictions will be made.
     */
    export interface Schema$GoogleCloudRecommendationengineV1beta1CatalogItemLevelConfig {
        /**
         * Optional. What level of the catalog are events uploaded at. See https://cloud.google.com/recommendations-ai/docs/catalog#catalog-levels for more details.
         */
        eventItemLevel?: string | null;
        /**
         * Optional. What level of the catalog are predictions made at. See https://cloud.google.com/recommendations-ai/docs/catalog#catalog-levels for more details.
         */
     ...
     */
    export interface Schema$GoogleCloudRecommendationengineV1beta1GetCatalogItemsWithItemGroupIdResponse {
        /**
         * The canonical catalog item representing all items associated with the item group id.
         */
        canonicalCatalogItem?: Schema$GoogleCloudRecommendationengineV1beta1CatalogItem;
        /**
    ...
    export class Resource$Projects$Locations$Catalogs$Catalogitems {
         ...
         *       // "projects/x/locations/global/catalogs/default_catalog".
         ...
         *       // "projects/x/locations/global/catalogs/default_catalog/catalogItems/some_catalog_item_id".
         *       name:
        ...
        /**
         * recommendationengine.projects.locations.catalogs.catalogItems.getGroupIdItems
         * @desc Method for getting the catalog items associated with item group id.
         * @example
         * // Before running the sample:
         * // - Enable the API at:
         * //   https://console.developers.google.com/apis/api/recommendationengine.googleapis.com
         ...
         *
         *   // Do the magic
         *   const res = await recommendationengine.projects.locations.catalogs.catalogItems.getGroupIdItems(
         *     {
         *       // Required. Catalog item identifier for prediction results.
         *       itemGroupId: 'placeholder-value',
         ...
         * });
         *
         * @alias recommendationengine.projects.locations.catalogs.catalogItems.getGroupIdItems
         * @memberOf! ()
         *
         * @param {object} params Parameters for request
         * @param {string=} params.itemGroupId Required. Catalog item identifier for prediction results.
         * @param {string} params.parent Required. Parent resource name of group id item, such as "projects/x/locations/global/catalogs/default_catalog".
         * @param {object} [options] Optionally override request options, such as `url`, `method`, and `encoding`.
         * @param {callback} callback The callback that handles the response.
         * @return {object} Request object
         */
        getGroupIdItems(params: Params$Resource$Projects$Locations$Catalogs$Catalogitems$Getgroupiditems, options: StreamMethodOptions): GaxiosPromise<Readable>;
        getGroupIdItems(params?: Params$Resource$Projects$Locations$Catalogs$Catalogitems$Getgroupiditems, options?: MethodOptions): GaxiosPromise<Schema$GoogleCloudRecommendationengineV1beta1GetCatalogItemsWithItemGroupIdResponse>;
        getGroupIdItems(params: Params$Resource$Projects$Locations$Catalogs$Catalogitems$Getgroupiditems, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        getGroupIdItems(params: Params$Resource$Projects$Locations$Catalogs$Catalogitems$Getgroupiditems, options: MethodOptions | BodyResponseCallback<Schema$GoogleCloudRecommendationengineV1beta1GetCatalogItemsWithItemGroupIdResponse>, callback: BodyResponseCallback<Schema$GoogleCloudRecommendationengineV1beta1GetCatalogItemsWithItemGroupIdResponse>): void;
        getGroupIdItems(params: Params$Resource$Projects$Locations$Catalogs$Catalogitems$Getgroupiditems, callback: BodyResponseCallback<Schema$GoogleCloudRecommendationengineV1beta1GetCatalogItemsWithItemGroupIdResponse>): void;
        getGroupIdItems(callback: BodyResponseCallback<Schema$GoogleCloudRecommendationengineV1beta1GetCatalogItemsWithItemGroupIdResponse>): void;
        /**
    ...
    export interface Params$Resource$Projects$Locations$Catalogs$Catalogitems$Getgroupiditems extends StandardParameters {
        /**
         * Required. Catalog item identifier for prediction results.
         */
        itemGroupId?: string;
        /**
         * Required. Parent resource name of group id item, such as "projects/x/locations/global/catalogs/default_catalog".
         */
        parent?: string;
    }
    ...
    export class Resource$Projects$Locations$Catalogs$Eventstores$Placements {
         ...
         *       // {name=projects/x/locations/global/catalogs/default_catalog/eventStores/default_event_store/placements/x}
    ...
    export class Resource$Projects$Locations$Catalogs$Eventstores$Predictionapikeyregistrations {
         ...
         *       // "projects/x/locations/global/catalogs/default_catalog/eventStores/default_event_store".
         *       parent:
         *         'projects/my-project/locations/my-location/catalogs/my-catalog/eventStores/my-eventStore',
         *
         *       // Request body metadata
         ...
         *       // "projects/x/locations/global/catalogs/default_catalog/eventStores/default_event_store/predictionApiKeyRegistrations/<YOUR_API_KEY>"
         *       name:
         ...
         *
         * @param {object} params Parameters for request
         * @param {string} params.name Required. The API key to unregister including full resource path. "projects/x/locations/global/catalogs/default_catalog/eventStores/default_event_store/predictionApiKeyRegistrations/<YOUR_API_KEY>"
         * @param {object} [options] Optionally override request options, such as `url`, `method`, and `encoding`.
         * @param {callback} callback The callback that handles the response.
         * @return {object} Request object
         */
    ...
    export interface Params$Resource$Projects$Locations$Catalogs$Eventstores$Predictionapikeyregistrations$Delete extends StandardParameters {
        /**
         * Required. The API key to unregister including full resource path. "projects/x/locations/global/catalogs/default_catalog/eventStores/default_event_store/predictionApiKeyRegistrations/<YOUR_API_KEY>"
         */
        name?: string;
    }
    ...
    export class Resource$Projects$Locations$Catalogs$Eventstores$Userevents {
         ...
         *       // "projects/x/locations/x/catalogs/default_catalog/eventStores/default_event_store".
         *       parent:
         *         'projects/my-project/locations/my-location/catalogs/my-catalog/eventStores/my-eventStore',
         *     }
         *   );
