...
export declare namespace contactcenteraiplatform_v1alpha1 {
    ...
    export class Resource$Projects$Locations$Contactcenters {
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        getAuthenticationConfig(params: Params$Resource$Projects$Locations$Contactcenters$Getauthenticationconfig, options: StreamMethodOptions): GaxiosPromise<Readable>;
        getAuthenticationConfig(params?: Params$Resource$Projects$Locations$Contactcenters$Getauthenticationconfig, options?: MethodOptions): GaxiosPromise<Schema$AuthenticationConfig>;
        getAuthenticationConfig(params: Params$Resource$Projects$Locations$Contactcenters$Getauthenticationconfig, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        getAuthenticationConfig(params: Params$Resource$Projects$Locations$Contactcenters$Getauthenticationconfig, options: MethodOptions | BodyResponseCallback<Schema$AuthenticationConfig>, callback: BodyResponseCallback<Schema$AuthenticationConfig>): void;
        getAuthenticationConfig(params: Params$Resource$Projects$Locations$Contactcenters$Getauthenticationconfig, callback: BodyResponseCallback<Schema$AuthenticationConfig>): void;
        getAuthenticationConfig(callback: BodyResponseCallback<Schema$AuthenticationConfig>): void;
        /**
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        updateAuthenticationConfig(params: Params$Resource$Projects$Locations$Contactcenters$Updateauthenticationconfig, options: StreamMethodOptions): GaxiosPromise<Readable>;
        updateAuthenticationConfig(params?: Params$Resource$Projects$Locations$Contactcenters$Updateauthenticationconfig, options?: MethodOptions): GaxiosPromise<Schema$AuthenticationConfig>;
        updateAuthenticationConfig(params: Params$Resource$Projects$Locations$Contactcenters$Updateauthenticationconfig, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        updateAuthenticationConfig(params: Params$Resource$Projects$Locations$Contactcenters$Updateauthenticationconfig, options: MethodOptions | BodyResponseCallback<Schema$AuthenticationConfig>, callback: BodyResponseCallback<Schema$AuthenticationConfig>): void;
        updateAuthenticationConfig(params: Params$Resource$Projects$Locations$Contactcenters$Updateauthenticationconfig, callback: BodyResponseCallback<Schema$AuthenticationConfig>): void;
        updateAuthenticationConfig(callback: BodyResponseCallback<Schema$AuthenticationConfig>): void;
    }
    ...
    export interface Params$Resource$Projects$Locations$Contactcenters$Getauthenticationconfig extends StandardParameters {
        /**
         * Required. The name of the AuthenticationConfig resource. Format: projects/{project\}/locations/{location\}/contactCenters/{contact_center\}/authentication-config
         */
        name?: string;
    ...
    export interface Params$Resource$Projects$Locations$Contactcenters$Updateauthenticationconfig extends StandardParameters {
        /**
         * Name of authentication config. Format: projects/{project\}/locations/{location\}/contactCenters/{contact_center\}/authentication-config
         */
        name?: string;
